 ...
 */
public class MyGuidance implements Guidance {

    private int tolerant_num;
    ...
    public MyGuidance(MyGenerator g, String testName, Duration duration, File outputDirectory) throws IOException {
        this.tolerant_num = 0;
        this.generator = g;
    ...
    public void handleResult(Result result, Throwable error) throws GuidanceException {
        ...
        if (result == Result.SUCCESS || result == Result.INVALID) {
            ...
            if (valid) {
                ...
                if(tolerant_num<5){ tolerant_num +=1;
                    generator.update();}
                else
                {generator.generate_new();tolerant_num=0;}
